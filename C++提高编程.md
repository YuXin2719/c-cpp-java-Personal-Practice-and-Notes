...
- 在startSpeech比赛流程控制的函数中，调用比赛函数，运行代码，测试比赛
...
- 在startSpeech比赛流程控制的函数中，调用显示比赛分数函数，运行代码，测试结果



#### 6.3.8 第二轮比赛

第二轮比赛流程用第一轮，只是比赛的轮数+1，其余流程不变
...
void SpeechManager::saveScore() {
	...
	for (vector<int>::iterator it = vVictory.begin(); it != vVictory.end(); it++) {
		ofs << *it << "," << m_Speaker[*it].m_Name << "," << m_Speaker[*it].m_Score[1] << "," << endl;
	}
	ofs << endl;
...
- 在startSpeech比赛流程控制的函数中，最后调用保存记录分数函数，测试，整个比赛完毕后记录保存情况
...
在main函数分支3选项中，调用清空比赛记录的接口，运行程序测试，并查看csv文件是否已经清空
...
![image-20250828092910988](https://gitee.com/YuXinHome/blogimg/raw/master/img/image-20250828092910988.png)
...
- 学生具体功能
  ...
  - 取消预约 --- 取消自身的预约，预约成功或者审核中的预约均可以取消
  - 注销登录 --- 退出登录
- 教师具体功能
  - 查看所有预约 --- 查看全部预约信息已经预约状态
  - 审核预约 --- 对学生的预约进行审核
  - 注销登录 --- 退出登录
- 管理员具体功能
...
![20200711221304621](https://gitee.com/YuXinHome/blogimg/raw/master/img/20200711221304621.png)
